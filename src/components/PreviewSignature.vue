...
const generateHtml = () => {
  const html = `
    ...
    props.imageAlt
              ...
              `
                ...
                <td style="padding:0cm;">
                  <p class="MsoNormal" style="line-height:15pt;">
                    <b>
                      <span style="font-size:10pt; font-family:Arial, sans-serif; color:rgb(227, 6, 19);">${
                        props.name
                      }</span>
                    </b>
          ...
          ${
            props.extra_text
              ? `<br /><p style="font-size:13px;line-height:20px;color:rgb(127,127,127);font-family:arial"><em>${props.extra_text}</em></p>`
              : ""
          }
        </div>
      </div>
...
<template>
  <div v-html="contentToDownload" id="previewSignature"></div>
